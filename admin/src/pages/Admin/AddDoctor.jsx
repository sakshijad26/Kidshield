...
const AddDoctor = () => {
    ...
    const [speciality, setSpeciality] = useState('BCG (Bacillus Calmette–Guérin)')
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Speciality (Vaccine)</p>
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="BCG (Bacillus Calmette–Guérin)">BCG (Bacillus Calmette–Guérin)</option>
                                <option value="OPV & IPV (Oral Polio Vaccine & Inactivated Polio Vaccine)">OPV & IPV (Oral Polio Vaccine & Inactivated Polio Vaccine)</option>
                                ...
                                <option value="Measles and Rubella (MR) Vaccine">Measles and Rubella (MR) Vaccine</option>
                            </select>
                        </div>
